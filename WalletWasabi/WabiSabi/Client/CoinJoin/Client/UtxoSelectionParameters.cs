...
{
	public static UtxoSelectionParameters FromRoundParameters(string coordinatorName, RoundParameters roundParameters, ScriptType[] scriptTypesSupportedByWallet)
	{
